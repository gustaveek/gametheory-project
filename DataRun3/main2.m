...
%selectionPressureS=[0.001]% 0.01 0.001 0.5];
for i = 1:length(pMut)
...
saveas(figure(1),'pMut0.01sP0.001.png','png')
save pMut0.01sP0.001.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.001sp0.001.png','png')
save pMut0.001sp0.001.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.0001sp0.001.png','png')
save pMut0.0001sp0.001.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.00001sp0.001.png','png')
save pMut0.00001sp0.001.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
