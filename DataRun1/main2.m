...
saveas(figure(1),'pMut0.01sP0.1.png','png')
save pMut0.01sP0.1.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.001sP0.1.png','png')
save pMut0.001sP0.1.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.0001sP0.1.png','png')
save pMut0.0001sP0.1.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
...
saveas(figure(1),'pMut0.00001sP0.1.png','png')
save pMut0.00001sP0.1.mat dataPop dataDist dataParam dataStrategies strategyOccuransMatrix
