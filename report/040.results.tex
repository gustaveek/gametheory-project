...
There are both runs where the dominating strategues are plentiful and quickly replaced, and others where few strategies dominate for long periods of time. That is, we have both runs where \pdhitwo{d}{d} and \pdhitwo{c}{c} interchange frequently, and runs where \pdhitwo{d}{d} dominate, and \pdhitwo{d}{d} dominate.
