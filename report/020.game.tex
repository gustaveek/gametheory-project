...
The sought steady state distribution $h^\ast$ is achieved through diagonalisation of $M$. The distribution $h^\ast$ is the normalised eigenvector corresponding to the eigenvalue $\lambda = 1$.\mypar
...
As said, the optimisation method used here is genetic algorithms. The population dynamics of the genetic algorithm is described in section \ref{sec:genetic} but at this phase the strategy encoding will be presented.\muypar
